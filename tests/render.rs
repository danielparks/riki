...
#[test]
fn empty_page() {
    let_assert!(Ok(page) = Page::from_string(""));
...
fn empty_page_with_title() {
    let_assert!(Ok(page) = Page::from_string("title: TITLE \n\n---"));
...
#[test]
fn no_title_one_h1() {
    let_assert!(Ok(page) = Page::from_string("# header\n"));
...
#[test]
fn no_title_two_h1() {
    let_assert!(Ok(page) = Page::from_string("# one\n\n# two\n"));
